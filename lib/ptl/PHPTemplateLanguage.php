...
include_once get_lib("lib.ptl.exception.PHPTemplateLanguageException");
include_once get_lib("lib.cache.user.IUserCacheHandler");
include_once get_lib("lib.phpscript.PHPScriptHandler");
include_once get_lib("lib.util.text.TextSanitizer");
